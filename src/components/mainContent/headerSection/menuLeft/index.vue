<template>
  <div class="menu-left" v-if="get_user_info.login">
    <div class="notification-menu">
      <el-dropdown trigger="click" class="notification-list">
        <div class="notification-btn">
          <img :src="get_user_info.user.avatar" :alt="get_user_info.user.name"/>
          <span v-text="get_user_info.user.name" class="nameRight"></span>
          <span class="nameRight">管理员</span>
          <span class="icon nameRight"></span>
        </div>
